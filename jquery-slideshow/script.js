function simpleSlider(element = '#simple-slider', auto = false, pause) {
    ...
    // function that starts the auto play and resets it incase the user navigated (clicked prev or next)
    function AutoPlay() {
    ...
    // Detect if user clicked on arrow for previous slide fade previous slide if it did
